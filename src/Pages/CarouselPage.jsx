  ...
  return (
    ...
    >
      <div className="flex flex-col items-start w-full max-w-6xl"> 
        <p 
          className="font-medium text-gray-400 mb-2"
          data-aos="fade-up"
        >
          Quienes somos
        </p>
        ...
        >
          ...
          <div className="flex flex-col gap-10">
            ...
            <a href="#contactanos" data-aos="fade-up" data-aos-delay="300">
        ...
        <div className="w-28 h-0.5 bg-gradient-to-r from-red-600 via-red-400 to-red-600 rounded-full mt-6 mb-16" data-aos="fade-up" data-aos-delay="400"></div>
